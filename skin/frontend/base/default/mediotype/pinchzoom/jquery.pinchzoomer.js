...
(function(window)
{
	function PinchZoomer(_pinchZoomerDiv, imageUrl, varsObj)
	{
		...
		//_vars
		var _vars = $.extend({ animDuration:0.3, maxZoom:5, minZoom:1, ease:Power4.easeOut, allowZoom:true, doubleTapZoom:2, zoomStep:0.5, adjustWidth:0, adjustHeight:0, preloaderUrl:"/skin/frontend/base/default/mediotype/pinchzoom/images/preloader.gif", resizeDuration:-1, onZoom:null, onZoomParams:null, onZoomStart:null, onZoomStartParams:null, onZoomComplete:null, onZoomCompleteParams:null, onImageLoad:null, onImageLoadParams:null }, varsObj),
		//elements
